...
// From chapter 7
public class TikaIndexer extends OneIndex {
...
//        }
        ...
        String indexDir = OneIndex.indexDir;
        String dataDir = OneIndex.dataDir;

        long start = new Date().getTime();
        TikaIndexer indexer = new TikaIndexer();
